    ...
    return (
        <div className="bg-white shadow rounded-lg p-5">
            ...
            <div className="grid md:grid-cols-3 gap-4">
                ...
                {data.middleName?.text && (
                    <div className="bg-amber-50 p-4 rounded">
                        <p className="text-sm">Middle Name: <span className="font-medium">{data.middleName.text}</span></p>
                        <p className="text-3xl font-bold text-amber-700 mt-2">{data.middleName.reduced}</p>
                        <p className="text-sm text-gray-600">Individual Value</p>
                    </div>
                )}
